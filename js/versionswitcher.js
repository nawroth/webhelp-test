...
function versionSwitcher( $ )
{
  ...
  {
    contentElement.load( "/chunked/" + newVersion + "/" + currentPage + CONTENT_ELEMENT_LOAD, function( response,
        status )
  ...
  {
    $( "div." + partName ).load( "/chunked/" + newVersion + "/" + currentPage + " div." + partName,
